...
```{r}
final_df[final_df == " communication skills" ] <- "communication"
```
...
```{r}
df_occur <- occurrences %>% slice_max(n, n=31)
df_occur <- df_occur[-c(7), ]
